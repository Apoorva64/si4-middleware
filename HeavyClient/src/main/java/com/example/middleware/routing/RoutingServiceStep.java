...
/**
 * <p>Classe Java pour RoutingService.Step complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="RoutingService.Step"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RoutingService.Step", propOrder = {
    "distance",
    "duration",
    "instruction",
    "name",
...
public class RoutingServiceStep {

    protected Double distance;
    protected Double duration;
    @XmlElementRef(name = "instruction", namespace = "http://schemas.datacontract.org/2004/07/Routing.wcf.library", type = JAXBElement.class, required = false)
    protected JAXBElement<String> instruction;
    @XmlElementRef(name = "name", namespace = "http://schemas.datacontract.org/2004/07/Routing.wcf.library", type = JAXBElement.class, required = false)
    protected JAXBElement<String> name;
    protected Integer type;
    @XmlElementRef(name = "way_points", namespace = "http://schemas.datacontract.org/2004/07/Routing.wcf.library", type = JAXBElement.class, required = false)
